...
-- CreateIndex
CREATE UNIQUE INDEX "Appointment_serviceId_key" ON "public"."Appointment"("serviceId");

-- CreateIndex
CREATE UNIQUE INDEX "Appointment_userId_key" ON "public"."Appointment"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "Reminder_userId_key" ON "public"."Reminder"("userId");
